...
export const createRuntime = (cfg, env = cfg.active) => {
 ...
 */
export const switchEnvironment = (rt, env) => {
    if (rt.activeSessionId) {
        throw new Error(`Cannot switch environment while session ${rt.activeSessionId} is open. ` +
